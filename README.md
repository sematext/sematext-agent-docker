...
|ENABLE_LOGSENE_STATS | Enables logging of tranmission stats of logs. Default value 'true'. Provides number of logs shipped, failed/successful http tranmissions (bulk requests to Logsene) and re-transmissions of failed requests. |
