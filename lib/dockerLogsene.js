...
DockerLogsene.prototype.parseKubernetesInfo = function (containerName, logObject) {
  ...
  if (fields.length === 3) {
    ...
    logObject.kubernetes.pod_name = fields[0]
    logObject.kubernetes.namespace = fields[1]
    logObject.kubernetes.container_name = fields[2]
    return logObject
  } else {
    return null
  }
      ...
      self.getLogObject(this.line,
        ...
        function (err, logObject) {
          ...
          if (logObject) {
            ...
            lp.parseKubernetesInfo(chunk.name, logObject)
