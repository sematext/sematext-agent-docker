...
function DockerLogsene () {
  ...
  setInterval(function() {
    console.log('Log count: \t' + self.logCount)
    console.log('Logs shipped:\t' + logsShipped)
    console.log('Log bulk req. failed:\t' + httpFailed)
    console.log('Log bulk re-transmits:\t' + httpFailed)
    self.logCount=0
    logsShipped=0
    httpFailed=0
    httpRetransmit=0
